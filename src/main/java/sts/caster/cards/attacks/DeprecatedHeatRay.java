...
public class DeprecatedHeatRay extends CasterCard {

    public static final String ID = CasterMod.makeID("DeprecatedHeatRay");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath("heatray.png");
