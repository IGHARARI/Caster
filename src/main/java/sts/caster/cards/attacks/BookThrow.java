...
public class BookThrow extends CasterCard {

    public static final String ID = CasterMod.makeID("BookThrow");
    ...
    public BookThrow() {
        ...
        baseDamage = DAMAGE;
        magicNumber = baseMagicNumber = BASE_STR_REDUCE;
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            ...
            upgradeMagicNumber(UPGR_STR_REDUCE);
