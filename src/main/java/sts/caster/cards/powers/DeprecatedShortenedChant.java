...
public class DeprecatedShortenedChant extends CasterCard {


    public static final String ID = CasterMod.makeID("DeprecatedShortenedChant");
    ...
    public DeprecatedShortenedChant() {
