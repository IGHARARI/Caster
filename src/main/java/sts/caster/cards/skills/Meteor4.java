...
public class Meteor4 extends CustomCard {
    ...
    public static final String ID = CasterMod.makeID("Meteor4");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new QueueDelayedCardAction(this, 4, new DamageAction(m, new DamageInfo(p, damage, DamageType.NORMAL))));
    }
