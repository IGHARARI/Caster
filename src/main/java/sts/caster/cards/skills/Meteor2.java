...
public class Meteor2 extends CustomCard {
    ...
    public static final String ID = CasterMod.makeID("Meteor2");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new QueueDelayedCardAction(this, 2, new DamageAction(m, new DamageInfo(p, damage, DamageType.NORMAL))));
    }
