...
public class RenderFrozenTagPatch {
	
	private static final Color fontColor = Settings.CREAM_COLOR.cpy();
	private static final Color baseColor = Color.CYAN.cpy();
	private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("FrozenTagStrings");
	        ...
	        if (!Settings.hideCards) {
	            ...
	            if (AbstractDungeon.player != null) {
	                if (__card.hasTag(CasterCardTags.FROZEN)) {
	                    ...
	                    String elecMessage = uiStrings.TEXT[0];
