...
public class MagicBookMemorizedCardField {
    public static SpireField<Boolean> inMagicBookField = new SpireField<>(() -> false);
    ...
    public static class MakeStatEquivalentCopy {
        public static AbstractCard Postfix(AbstractCard result, AbstractCard self) {
            ...
            inMagicBookField.set(result, inMagicBookField.get(self)); // Read:
