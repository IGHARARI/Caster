...
//
//@Deprecated
//public class DeprecatedFrozenPileViewScreen implements ScrollBarListener {
...
//
//    public DeprecatedFrozenPileViewScreen() {
...
//        DeprecatedFrozenPileViewScreen.drawStartX = Settings.WIDTH;
//        DeprecatedFrozenPileViewScreen.drawStartX -= 5.0f * AbstractCard.IMG_WIDTH * 0.75f;
//        DeprecatedFrozenPileViewScreen.drawStartX -= 4.0f * Settings.CARD_VIEW_PAD_X;
//        DeprecatedFrozenPileViewScreen.drawStartX /= 2.0f;
//        DeprecatedFrozenPileViewScreen.drawStartX += AbstractCard.IMG_WIDTH * 0.75f / 2.0f;
//        DeprecatedFrozenPileViewScreen.padX = AbstractCard.IMG_WIDTH * 0.75f + Settings.CARD_VIEW_PAD_X;
//        DeprecatedFrozenPileViewScreen.padY = AbstractCard.IMG_HEIGHT * 0.75f + Settings.CARD_VIEW_PAD_Y;
...
//                ++scrollTmp;
//            }
//            this.scrollUpperBound = Settings.DEFAULT_SCROLL_LIMIT + scrollTmp * DeprecatedFrozenPileViewScreen.padY;
//        } else {
//            this.scrollUpperBound = Settings.DEFAULT_SCROLL_LIMIT;
//        }
...
//                ++lineNum;
//            }
//            cards.get(i).target_x = drawStartX + mod * DeprecatedFrozenPileViewScreen.padX;
...
//            DeprecatedFrozenPileViewScreen.drawStartY = Settings.HEIGHT * 0.5f;
//        } else {
//            DeprecatedFrozenPileViewScreen.drawStartY = Settings.HEIGHT * 0.66f;
//        }
//        this.calculateScrollBounds();
//    }
//
...
//                ++lineNum;
//            }
//            cards.get(i).current_x = DeprecatedFrozenPileViewScreen.drawStartX + mod * DeprecatedFrozenPileViewScreen.padX;
//            cards.get(i).current_y = DeprecatedFrozenPileViewScreen.drawStartY + this.currentDiffY - lineNum * DeprecatedFrozenPileViewScreen.padY - MathUtils.random(100.0f * Settings.scale, 200.0f * Settings.scale);
...
//        }
//        FontHelper.renderDeckViewTip(sb, DeprecatedFrozenPileViewScreen.DESC, 96.0f * Settings.scale, Settings.CREAM_COLOR);
//        if (this.shouldShowScrollBar()) {
...
//        return this.scrollUpperBound > DeprecatedFrozenPileViewScreen.SCROLL_BAR_THRESHOLD;
//    }
//
//}